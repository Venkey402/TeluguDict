...
public class fragment1 extends Fragment {
    ...
    public ArrayAdapter<String> getMyArrayAdapter(ArrayList<String> frag1data)
    {
        arrayAdapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_expandable_list_item_1, frag1data);
        listView.setAdapter(arrayAdapter);
        return arrayAdapter;
    }
}
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH= "data/data/com.telugu.a5pm1/databases/";
...
//        DB.execSQL("drop Table if exists words");
    ...
    public Cursor getWordsMeaningsdata ()
    {
        SQLiteDatabase DB = this.getWritableDatabase();
        cursor = DB.rawQuery("select meaning from words_meanings order by 1 ", null);
        return cursor;
    }
